...
function Hero() {
  return (
    <section className="min-h-[618px] lg:min-h-[815px] pt-9 lg:bg-circle lg:bg-no-repeat bg-right-top" id="home">
      <div className="container mx-auto">
        ...
        <div className="flex flex-col items-center lg:flex-row lg:items-start pt-32">
          <div className="flex-1 lg:mt-12">
            ...
            <p className="mb-6 lg:mb-12 max-w-[480px] lg:text-lg" data-aos="fade-down" data-aos-delay="600">
            ...
            <div className="mb-12 space-x-4" data-aos="fade-down" data-aos-delay="700">
              ...
              <button className="btn btn-sm lg:btn-lg text-heading bg-transparent border border-stroke-1 px-4 hover:bg-stroke-3 transition">Learn More</button>
            </div>
          </div>

          <div className="w-full bg-circle bg-cover lg:bg-none lg:w-auto">
            <div className="flex-1 flex justify-center lg:justify-end" data-aos="fade-left" data-aos-delay="600">
              <div className="w-[234px] h-[234px] lg:w-[504px] lg:h-[744px] lg:mt-0">
                <Parallax bgImage={Guy} strength={200} bgImageAlt="Heroes Pics" className="w-full h-full p-28 lg:p-16" />
              </div>
            </div>
          </div>
        </div>
